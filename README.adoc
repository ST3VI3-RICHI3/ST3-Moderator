...
The bot can be added link:https://discordapp.com/api/oauth2/authorize?client_id=459014792464695317&permissions=8&scope=bot[here,window=_blank]. +
You can also link:https://discord.gg/fPNPq48[join,window=_blank] the bot testing server.
